  ...
  return (
    <>
      ...
      <div className="mx-3  md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-200 min-h-[80vh] md:w-[35%]">
        ...
        <h2 className="text-lg font-bold my-5 mx-3">Your Todos</h2>
        <div className="todos">
          ...
          {todos.map(item => {
            ...
            <div key={item.id} className="todo flex justify-between my-3">
                ...
                <div className="buttons flex h-full">
                  ...
                  <button onClick={(e) => { handleDelete(e, item.id) }} className="bg-violet-800 hover:bg-violet-950 p-2 py-1 text-sm font-bold text-white rounded-md mx-1 cursor-pointer"><MdDelete/></button>
                </div>
              </div>
            )
          })}
